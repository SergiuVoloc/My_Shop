...
namespace My_Shop.Services
{
    public class BasketService
    {
        ...
        public const string BasketSectionName = "eCommerceBasket";
        ...
        {
            HttpCookie cookie = httpContext.Request.Cookies.Get(BasketSectionName);
        ...
        private Basket CreateNewBasket(HttpContextBase httpContext)
        {
            ...
            HttpCookie cookie = new HttpCookie(BasketSectionName);
        ...
        public void AddToBasket(HttpContextBase httpContext, string productId)
        {
            ...
            //if item doesn't the  exist in the basket
            if (item == null)
            {
                item = new BasketItem()
                {
        ...
        public List<BasketItemViewModel> GetBasketItems(HttpContextBase httpContext)
        {
            ...
            if (basket != null)
            {
                //if we retrieved the basket, we query the product table and basket items to get info
